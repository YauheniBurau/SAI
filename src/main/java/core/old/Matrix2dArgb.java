...
//    public Matrix2d<ARGB> convertTo256Colors(){
//        MVQ2 mvq2 = new MVQ2();
//        int[] img = Matrix2dArgb.matrix2dArgbToArrayInt(this);
//        int[] pallete256 = mvq2.to_256_color_paletted_image(img);
//        Matrix2d<ARGB> m2d = Matrix2dArgb.arrayIntToMatrix2dArgb(img, this.size, this.sizeY, pallete256);
//        return m2d;
//    }

    public static int[] matrix2dArgbToArrayInt(Matrix2d<ARGB> in){
    ...
    public static Matrix2d<ARGB> arrayIntToMatrix2dArgb(int[] in, int sizeX, int sizeY, int[] pallete256){
        MVQ2 mvq2 = new MVQ2();
        Matrix2d<ARGB> res = new Matrix2d<ARGB>(ARGB.class, sizeX, sizeY);
        int n = 0;
        int iv, index;
        ARGB argb = null;
...
//
//    /**
//     * Stretch size of matrix2d to 2-times on axis x and y by doubling every coords
//     * @return
//     */
//    public Matrix2dArgb stretch2x(){
//        int x = this.size;
//        int y = this.sizeY;
//        int resizedX = this.size*2;
...
//        Matrix2dArgb m2d = new Matrix2dArgb(this.size, this.sizeY);
