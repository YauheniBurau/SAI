...
import core.application.algorithm.helper.LabToArgb;
 ...
 */
public class Matrix2dLabToMatrix2dArgb extends BaseAlgorithm {
    private Model model;
    ...
    public Matrix2dLabToMatrix2dArgb(Model model, String inKey, String outKey) {
        this.model = model;
        this.inKey = inKey;
        this.outKey = outKey;
    ...
    public Matrix2dLabToMatrix2dArgb(Model model, String inKey, String outKey, TransformParams transformParams) {
        this.model = model;
        this.inKey = inKey;
        this.outKey = outKey;
        this.whitePoint = Lab.whitePoint;
