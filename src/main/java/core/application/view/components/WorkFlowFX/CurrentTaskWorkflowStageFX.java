...
public class CurrentTaskWorkflowStageFX extends StageFX {
    ...
    public void init(){
        ...
        ButtonFX btnStop = new ButtonFX()
                .withText("Stop")
                .withTooltip("interrupt all threads of processing current workflow")
                .withOnAction(hBtnStop);
        ButtonFX btnClose = new ButtonFX()
                .withText("Close")
                .withTooltip("interrupt all threads of processing current workflow and close window")
                .withOnAction(hBtnClose);
        HBox btnsBox = new HBox(btnStop, btnClose);
        btnsBox.setSpacing(5);
        btnsBox.setPadding(new Insets(10));
        // scrollPane + textArea for showing log of threadTask of workflow
