 ...
 */
public class ShowOpenDialogController extends BaseController{
    FileChooser fileChooser;

    public ShowOpenDialogController(Model model, Transformation transformation, FileChooser fileChooser) {
