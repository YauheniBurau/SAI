...
import core.application.algorithm.process.Algorithm;
import core.application.algorithm.process.Matrix2dArgbToImageView;
import core.application.algorithm.process.PngFileToMatrix2dArgb;
import core.application.algorithm.process.ShowOpenDialogToPngFile;
...
public class ArtificialIntelligenceApplication extends Application {
    ...
    public void prepareApplication(Model model){
        ...
        algorithm1.add(new PngFileToMatrix2dArgb(model, "PngFile.in1","Matrix2dArgb.1") );
        algorithm1.add(new Matrix2dArgbToImageView(model, "Matrix2dArgb.1", "ImageView.1") );
        ...
        algorithm2.add(new PngFileToMatrix2dArgb(model, "PngFile.in2","Matrix2dArgb.2") );
        algorithm2.add(new Matrix2dArgbToImageView(model, "Matrix2dArgb.2", "ImageView.2") );
