...
import core.converter.Matrix2dConverter;
import core.filter.Matrix2dArgbFilter;
import core.element.ARGB;
import core.io.Matrix2dFileReader;
import core.io.Matrix2dFileWriter;
import core.matrix.Matrix2d;
import core.statistic.Matrix2dStatistic;
import core.transform.Matrix2dTransform;
...
//        Matrix2d<ARGB> m2d = Matrix2dArgbFilter.argbToColorDiff(m);
    ...
    public void checkLoadSaveRGB(){
        Matrix2d<ARGB> m2d = Matrix2dFileReader.loadRGB(path + imageFile);
        Matrix2dFileWriter.saveRGB(m2d, path + imageFile + "_copy.png", "png");
    }

    @Test
    public void checkRgbToGrey256(){
        Matrix2d<ARGB> m2d = Matrix2dFileReader.loadRGB(path + imageFile);
        Matrix2d<ARGB> m2dGrey256 = Matrix2dArgbFilter.rgbToGrey256(m2d);
        Matrix2dFileWriter.saveRGB(m2dGrey256, path + imageFile + "_rgbToGrey256.png", "png");
    }

    @Test
    public void checkArgbToGrey256(){
        Matrix2d<ARGB> m2d = Matrix2dFileReader.loadRGB(path + imageFile);
        Matrix2d<ARGB> m2dGrey256 = Matrix2dArgbFilter.argbToGrey256(m2d);
        Matrix2dFileWriter.saveRGB(m2dGrey256, path + imageFile + "_argbToGrey256.png", "png");
    }
    ...
    public void checkRgbToColorDiff1(){
        ...
        Matrix2dFileWriter.saveRGB(m1, path + imageFile +"_rgbToColorDiff1.png", "png");
        Matrix2d<ARGB> m2 = Matrix2dArgbFilter.argbToColorDiff(m1);
        Matrix2dFileWriter.saveRGB(m2, path + imageFile + "_rgbToColorDiff2.png", "png");
        Matrix2d<ARGB> m3 = Matrix2dArgbFilter.argbToColorDiff(m2);
        Matrix2dFileWriter.saveRGB(m3, path + imageFile + "_rgbToColorDiff3.png", "png");
        Matrix2d<ARGB> m4 = Matrix2dArgbFilter.argbToColorDiff(m3);
        Matrix2dFileWriter.saveRGB(m4, path + imageFile + "_rgbToColorDiff4.png", "png");
        Matrix2d<ARGB> m5 = Matrix2dArgbFilter.argbToColorDiff(m4);
        Matrix2dFileWriter.saveRGB(m5, path + imageFile + "_rgbToColorDiff5.png", "png");
    }
    ...
    public void checkRgbToColorDiff2(){
        ...
        Matrix2dFileWriter.saveRGB(m, path + imageFile +"_rgbToColorDiff.png", "png");
    }
    ...
    public void checkRgbToColorDiffWithLevel(){
        ...
        for(int minLevel = 0; minLevel<=255; minLevel += 25) {
            ...
            Matrix2dFileWriter.saveRGB(m2dLevel, path + imageFile +"_diffAndLevel" + minLevel + ".jpg", "jpg");
        }
    }

    @Test
    public void checkMatrixReduce2x4x8x16x_3(){
        Matrix2d<ARGB> matrix2D = Matrix2dFileReader.loadRGB(path + imageFile);
        Matrix2d<ARGB> reduced1x2 = Matrix2dTransform.reduce(matrix2D, 2);
        Matrix2dFileWriter.saveRGB(reduced1x2, path + imageFile + "1x2.png", "png");
        Matrix2d<ARGB> reduced1x4 = Matrix2dTransform.reduce(reduced1x2, 2);
        Matrix2dFileWriter.saveRGB(reduced1x4, path + imageFile + "1x4.png", "png");
        Matrix2d<ARGB> reduced1x8 = Matrix2dTransform.reduce(reduced1x4, 2);
        Matrix2dFileWriter.saveRGB(reduced1x8, path + imageFile + "1x8.png", "png");
        Matrix2d<ARGB> reduced1x16 = Matrix2dTransform.reduce(reduced1x8, 2);
        Matrix2dFileWriter.saveRGB(reduced1x16, path + imageFile + "1x16.png", "png");
    }
    ...
    public void checkMatrixReducex4_ColorDiff(){
        ...
        for(int minLevel = 0; minLevel<=255; minLevel += 25) {
            ...
            Matrix2dFileWriter.saveRGB(level, path + imageFile + "_reducedx4_diffWithLevel" + minLevel + ".png", "png");
        }
    }
    ...
    public void checkRgbToColorDiffWithLevel_127_256(){
        ...
        Matrix2dFileWriter.saveRGB(m2dLevel, path + imageFile + "_diffWithLevel_"+ minLevel + "_" + maxLevel +".jpg", "jpg");
    }
    ...
    public void checkRgbToGrey256AndColorDiff(){
        ...
        Matrix2dFileWriter.saveRGB(m2dDiff, path + imageFile + "_rgbToGrey256AndDiff.png", "png");
    }
    ...
    public void ColorDiffAndColors8() {
        ...
        Matrix2dFileWriter.saveRGB(colors8, path + imageFile + "_ColorDiffAndColors8.png", "png");
    }
    ...
    public void ColorDiffAndColors4() {
        ...
        Matrix2dFileWriter.saveRGB(colors4, path + imageFile + "_ColorDiffAndColors4.png", "png");
    }
    ...
    public void ColorDiffAndColors2() {
        ...
        Matrix2dFileWriter.saveRGB(colors2, path + imageFile + "_ColorDiffAndColors2.png", "png");
    }


//    @Test
//    public void tryGetColorXor() {
//        IMatrix matrix2D = Matrix2dConverter.FileImageToMatrix2d(path + "anime.png");
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_grey.jpg", "jpg");
//    }
//
//    @Test
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_grey.jpg", "jpg");
//        matrix2D = Matrix2dConverter.FileImageToMatrix2d(path + "apple.jpg");
//        matrix0 = Matrix2dConverter.matrix2dGrey256(matrix2D);
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "apple_grey256.jpg", "jpg");
//    }
//
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_grey4.jpg", "jpg");
//        matrix2D = Matrix2dConverter.FileImageToMatrix2d(path + "apple.jpg");
//        matrix0 = Matrix2dConverter.matrix2dGrey4(matrix2D);
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "apple_grey4.jpg", "jpg");
//    }
//
//    @Test
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_grey2.jpg", "jpg");
//        matrix2D = Matrix2dConverter.FileImageToMatrix2d(path + "apple.jpg");
//        matrix0 = Matrix2dConverter.matrix2dGrey2(matrix2D);
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "apple_grey2.jpg", "jpg");
//    }
//
//    @Test
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_Color8x8x8.jpg", "jpg");
//        matrix2D = Matrix2dConverter.FileImageToMatrix2d(path + "apple.jpg");
//        matrix0 = Matrix2dConverter.matrix2dColor8x8x8(matrix2D);
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "apple_Color8x8x8.jpg", "jpg");
//    }
//
//    @Test
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_Color4x4x4.jpg", "jpg");
//        matrix2D = Matrix2dConverter.FileImageToMatrix2d(path + "apple.jpg");
//        matrix0 = Matrix2dConverter.matrix2dColorNxNxN(matrix2D, 4);
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "apple_Color4x4x4.jpg", "jpg");
//    }
//
//    @Test
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_Color2x2x2.jpg", "jpg");
//        matrix2D = Matrix2dConverter.FileImageToMatrix2d(path + "apple.jpg");
//        matrix0 = Matrix2dConverter.matrix2dColorNxNxN(matrix2D, 2);
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "apple_Color2x2x2.jpg", "jpg");
//    }
//
//    @Test
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_Color3x3x3.bmp", "bmp");
//        matrix2D = Matrix2dConverter.FileImageToMatrix2d(path + "apple.jpg");
//        matrix0 = Matrix2dConverter.matrix2dColorNxNxN(matrix2D, 3);
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "apple_Color3x3x3.bmp", "bmp");
//    }
//
//    @Test
...
//        Matrix2dConverter.matrix2dToFileImage(matrix0, path + "anime_grey256.jpg", "jpg");
//        Matrix2dConverter.matrix2dToFileImage(matrixEdges, path + "anime_grey256DetectedEdges.jpg", "jpg");
//    }
//
//    @Test
...
//    }
    ...
    public void toColors8() {
        ...
        Matrix2dFileWriter.saveRGB(colors8, path + imageFile + "_Colors8.png", "png");
    }
    ...
    public void toColors4() {
        ...
        Matrix2dFileWriter.saveRGB(colors4, path + imageFile + "_Colors4.png", "png");
    }
    ...
    public void toColors2x2x2() {
        ...
        Matrix2dFileWriter.saveRGB(colors, path + imageFile + "_Colors2x2x2.png", "png");
    }
    ...
    public void toColors2x2x2AndDiff() {
        ...
        Matrix2dFileWriter.saveRGB(m2dDiff, path + imageFile + "_Colors2x2x2andDiff.png", "png");
    }
    ...
    public void reduceX16_ColorDiff() {
        ...
        Matrix2d<ARGB> colors = Matrix2dConverter.matrix2dArgbToColorsNxNxN(matrix2D, 2);
        Matrix2d<ARGB> m2dDiff = Matrix2dArgbFilter.argbToColorDiff(colors);
        Matrix2dFileWriter.saveRGB(m2dDiff, path + imageFile + "_reduceX16_ColorDiff.png", "png");
    }
    ...
    public void convoluted2x4x8x16x32x64x128x() {
        int min =190;
        int max = 205;
        Matrix2d<ARGB> m0 = Matrix2dFileReader.loadRGB(path + imageFile);
        Matrix2d<ARGB> mGrey = Matrix2dConverter.matrix2dArgbToColorsNxNxN(m0, 4);
        Matrix2dFileWriter.saveRGB(mGrey, path + imageFile + "_grey256.png", "png");
...
//        Matrix2d<ARGB> filtered = Matrix2dArgbFilter.argbMinMax(mGrey, -1, 256, min, max, min, max, min, max);
        ...
        Matrix2dFileWriter.saveRGB(mDiff, path + imageFile + "_convoluted0x.png", "png");
        Matrix2d<ARGB> m2 = Matrix2dTransform.argbConvolute2x(mDiff);
        Matrix2dFileWriter.saveRGB(m2, path + imageFile + "_convoluted2x.png", "png");
        Matrix2d<ARGB> m4 = Matrix2dTransform.argbConvolute2x(m2);
        Matrix2dFileWriter.saveRGB(m4, path + imageFile + "_convoluted4x.png", "png");
        Matrix2d<ARGB> m8 = Matrix2dTransform.argbConvolute2x(m4);
        Matrix2dFileWriter.saveRGB(m8, path + imageFile + "_convoluted8x.png", "png");
        Matrix2d<ARGB> m16 = Matrix2dTransform.argbConvolute2x(m8);
        Matrix2dFileWriter.saveRGB(m16, path + imageFile + "_convoluted16x.png", "png");
        Matrix2d<ARGB> m32 = Matrix2dTransform.argbConvolute2x(m16);
        Matrix2dFileWriter.saveRGB(m32, path + imageFile + "_convoluted32x.png", "png");
        Matrix2d<ARGB> m64 = Matrix2dTransform.argbConvolute2x(m32);
        Matrix2dFileWriter.saveRGB(m64, path + imageFile + "_convoluted64x.png", "png");
        Matrix2d<ARGB> m128 = Matrix2dTransform.argbConvolute2x(m64);
        Matrix2dFileWriter.saveRGB(m128, path + imageFile + "_convoluted128x.png", "png");
    ...
    public void color256Statistic() {
        ...
        Matrix2dFileWriter.saveRGB(mReduceColors, path + imageFile + "_reducedColors1.png", "png");
        Matrix2d<ARGB> m1 = Matrix2dArgbFilter.argbToColorDiff(mReduceColors);
        Matrix2dFileWriter.saveRGB(m1, path + imageFile + "_reducedColors_diff1.png", "png");
...
//            }
//        }
//        Matrix2dFileWriter.saveRGB(mReduceColors, path + imageFile + "_reducedColors2.png", "png");
//        m1 = Matrix2dArgbFilter.argbToColorDiff(mReduceColors);
//        Matrix2dFileWriter.saveRGB(m1, path + imageFile + "_reducedColors_diff2.png", "png");
    }
    ...
    public void useStatisticColorToDetectEdges() {
        ...
        Matrix2dFileWriter.saveRGB(filtered, path + imageFile + "_x8grey2ByThreshold.png", "png");
    }
    ...
    public void useStatisticColorChannelsToDetectEdges() {
        ...
        Matrix2dFileWriter.saveRGB(filteredR, path + imageFile + "_x8grey2ByRChannel.png", "png");
        Matrix2d<ARGB> diffR = Matrix2dArgbFilter.argbToColorDiff(filteredR);
        Matrix2dFileWriter.saveRGB(diffR, path + imageFile + "_x8grey2ByRChannelDiff.png", "png");

        Matrix2d<ARGB> filteredG = Matrix2dArgbFilter.argbToGrey2ByGChannel(m2, threshold);
        Matrix2dFileWriter.saveRGB(filteredG, path + imageFile + "_x8grey2ByGChannel.png", "png");
        Matrix2d<ARGB> diffG = Matrix2dArgbFilter.argbToColorDiff(filteredG);
        Matrix2dFileWriter.saveRGB(diffG, path + imageFile + "_x8grey2ByGChannelDiff.png", "png");

        Matrix2d<ARGB> filteredB = Matrix2dArgbFilter.argbToGrey2ByBChannel(m2, threshold);
        Matrix2dFileWriter.saveRGB(filteredB, path + imageFile + "_x8grey2ByBChannel.png", "png");
        Matrix2d<ARGB> diffB = Matrix2dArgbFilter.argbToColorDiff(filteredB);
        Matrix2dFileWriter.saveRGB(diffB, path + imageFile + "_x8grey2ByBChannelDiff.png", "png");
        ...
        Matrix2dFileWriter.saveRGB(diffSum, path + imageFile + "_x8grey2ByRGBChannelsSum_Diff.png", "png");
    }
    ...
    public void useThresholdColorToDetectEdges() {
        ...
        Matrix2dFileWriter.saveRGB(m, path + imageFile + "_convoluted8x.png", "png");
        ...
        Matrix2dFileWriter.saveRGB(filtered, path + imageFile + "_1x8_grey2.png", "png");
        ...
        Matrix2dFileWriter.saveRGB(filtered, path + imageFile + "_1x8_threshold1x2.png", "png");
    }
...
//        Matrix2d<ARGB> m1x2 = Matrix2dTransform.argbConvolute2x(m0x);
        ...
        Matrix2dFileWriter.saveRGB(m1, path + imageFile + "_m1_Mask.png", "png");
        Matrix2dFileWriter.saveRGB(m2, path + imageFile + "_m2_Mask.png", "png");
        ...
        Matrix2dFileWriter.saveRGB(m1_1, path + imageFile + "_m1_1_Mask.png", "png");
        Matrix2dFileWriter.saveRGB(m1_2, path + imageFile + "_m1_2_Mask.png", "png");
        ...
        Matrix2dFileWriter.saveRGB(m2_1, path + imageFile + "_m2_1_Mask.png", "png");
        Matrix2dFileWriter.saveRGB(m2_2, path + imageFile + "_m2_2_Mask.png", "png");
        ...
        Matrix2dFileWriter.saveRGB(finish, path + imageFile + "_edges.png", "png");
